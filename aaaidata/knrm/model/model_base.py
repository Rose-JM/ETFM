...
import numpy as np
from team2box.aaaidata.knrm.data import DataGenerator
...
class BaseNN(Configurable):
    ...
    def gen_mask(self, Q, D, use_exact=True):
        ...
        """
        real_batch_size = Q.shape[0]  # 动态 batch size
        mask = np.zeros((real_batch_size, self.max_q_len, self.max_d_len), dtype=np.float32)
